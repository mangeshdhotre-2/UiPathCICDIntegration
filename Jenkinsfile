pipeline {
    ...
    stages {
        ...
        stage('Build UiPath Package') {
            steps {
                script {
                  bat "\"C:\\Users\\Admin\\AppData\\Local\\Programs\\UiPath\\Studio\\UiPath.Studio.CommandLine.exe\" publish -p \"C:\\Users\\Admin\\Documents\\UiPath\\UiPath_CICD_Integration\\project.json\" --target \"C:\\Users\\Admin\\Documents\\UiPath\\UiPath_CICD_Integration\\Output\\""
                }
            }
        }
