pipeline {
    ...
    stages {
        ...
        stage('Build UiPath Package') {
            steps {
                script {
                    bat "\"C:\\Users\\Admin\\AppData\\Local\\Programs\\UiPathPlatform\\Studio\\26.0.186-cloud.22084\\UiPath.Studio.CommandLine.exe\" pack -p \"D:\\UiPath\\UiPath_CICD_Integration\\project.json\" -o \"C:\\Users\\Admin\\Documents\\UiPath\\UiPath_CICD_Integration\\Output\""
